...
// ==========================================
export const COMPANY_NAME = "GLAMMYS EXECUTIVE SUITES";
export const COMPANY_PHONE = "27789727452"; // Format: CountryCode + Number (No + symbol)
export const COMPANY_PHONE_2 = "27633175581"; // Format: CountryCode + Number (No + symbol)
